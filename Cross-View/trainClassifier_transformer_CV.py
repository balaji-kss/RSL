...
#dy_pretrain = '/home/balaji/Documents/code/RSL/Thesis/RSL/Cross-View/ModelFile/crossView_NUCLA/Single/tenc_dyan_cl1/T36_fista01_openpose/95.pth'
...
net = load_pretrain_models(net, dy_pretrain, tenc_pretrain)
...
'for dy+cl:'
optimizer = torch.optim.SGD(filter(lambda x: x.requires_grad, net.parameters()), lr=lr1, weight_decay=0.001, momentum=0.9)
...
scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[30, 70], gamma=0.1)
