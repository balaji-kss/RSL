...
saveModel = modelRoot + dataset + '/exp4/'
...
if transformer:
    ...
    optimizer = torch.optim.SGD([
                                {'params':filter(lambda x: x.requires_grad, net.transformer.parameters()), 'lr':1e-3},
                                {'params':filter(lambda x: x.requires_grad, net.sparseCoding.parameters()), 'lr':1e-3},
